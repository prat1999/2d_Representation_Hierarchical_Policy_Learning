...
# LL: 206-demo Approach 2 run on PushT, c1 = 0.1, 200-epoch training
# (2026-08-27 retrain matching the WCA baseline's 200-epoch budget; the earlier
# 100-epoch run was 2026.08.21/02.24.45, evaluated with epoch_99.ckpt).
LL_EXP_DIR="${LL_REPO}/outputs/2026.08.27/11.56.53_push_t_task_APPROACH2_c1_0.1_206demo_push_t_task_goal_gmm_aux"
...
OUTPUT_BASE="APPROACH2_2D_DIT_PUSHT_50_SAMPLES_c1_0.1_200EP"
