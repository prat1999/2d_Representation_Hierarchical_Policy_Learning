...
# LL: 206-demo Approach 2 FIXED_INTERVAL keypoint-variant run on PushT, c1 = 0.1,
# 200-epoch training (2026-08-27 batch, same budget as the WCA baseline).

LL_EXP_DIR="${LL_REPO}/outputs/2026.08.27/11.56.53_push_t_task_APPROACH2_FIXED_INTERVAL_c1_0.1_206demo_push_t_task_goal_gmm_aux_fixed_interval"
...
OUTPUT_BASE="APPROACH2_2D_DIT_PUSHT_50_SAMPLES_FIXED_INTERVAL_c1_0.1_200EP"
