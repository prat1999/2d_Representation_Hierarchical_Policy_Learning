...
#SBATCH --job-name a2-eval-pusht-rdp-c1-0.1
#SBATCH -o /ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Code/PushT_Task/diffusion_policy/approach2_eval/RDP/logs/job_%j.out
#SBATCH -e /ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Code/PushT_Task/diffusion_policy/approach2_eval/RDP/logs/job_%j.err
...
INNER_SCRIPT="${SCRIPT_DIR}/eval_approach2_pusht_rdp_c1_0.1_ALL_SEEDS.sh"
