...
# LL: 206-demo Approach 2 BAYESIAN_VELOCITY keypoint-variant run on PushT, c1 = 0.1,
# 200-epoch training (2026-08-27 batch, same budget as the WCA baseline).

LL_EXP_DIR="${LL_REPO}/outputs/2026.08.27/11.56.53_push_t_task_APPROACH2_BAYESIAN_VELOCITY_c1_0.1_206demo_push_t_task_goal_gmm_aux_bayesian_velocity"
...
OUTPUT_BASE="APPROACH2_2D_DIT_PUSHT_50_SAMPLES_BAYESIAN_VELOCITY_c1_0.1_200EP"
