...
#SBATCH -t 2:00:00 # RDP run of this job took ~8 min end to end (70s stage, 361s gen, 29s ship)
#SBATCH --job-name coffee-prep-d1-awe-grip-pred-gen
...
#
# Pipeline (identical to RDP_DATAGEN/coffeePreperationD1.sh):
...
#      is ~16 GB for this task (705 frames/demo, ~235 KB/frame).
#
...
FINAL_OCEAN_DIR="${AWE_ROOT}/COFFEE_PREPERATION_D1_GMM_PRED"

# --- checkpoint (CKPT_EPOCH env var, default 89) ----------------------------
CKPT_EPOCH="${CKPT_EPOCH:-89}"
RUN_DIR="${REPO_DIR}/logs/train_COFFEE_PREPERATION_D1_GOAL_SWAP_AWE_GRIP_100demo/2026-09-08/09-55-45"
...
DEST_PRED_DIR="${SCRATCH_ROOT}/COFFEE_PREPERATION_D1_GMM_PRED_AWE"  # generator outputs
