...
#SBATCH --job-name coffee-prep-d1-high-level-awe-grip-100demo
#SBATCH -o /ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Code/2d_Representation_Hierarchical_Policy_Learning/ROBO_HIGH_LEVEL_TRAINING_SCRIPT/RDP_TRAINING_SCRIPTS/COFFEE_PREPERATION_D1/AWE_GRIP_FOLDER/logs/job_%j.out
#SBATCH -e /ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Code/2d_Representation_Hierarchical_Policy_Learning/ROBO_HIGH_LEVEL_TRAINING_SCRIPT/RDP_TRAINING_SCRIPTS/COFFEE_PREPERATION_D1/AWE_GRIP_FOLDER/logs/job_%j.err
#SBATCH --mail-type=END
#SBATCH --mail-user=pbhowal@andrew.cmu.edu

# 100-DEMO variant: train articubot (GMM cross-displacement high-level policy)
# on COFFEE_PREPERATION_D1 using AWE-grip goals (goal_gripper_pcd_awe) from the
...
#
# The AWE tree currently holds demo_0 .. demo_99 only; NUM_DEMOS > 100 fails
...
# identical to RDP_FOLDER/Coffee_Preperation_D1_100.sh so the goal sources are
# directly comparable.
...
EXTRA_SRC_DIR="/ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Dataset/D2/EXTRA_KEYPOINTS/AWE_EXTRA_KEYPOINTS/EXTRA_KEYPOINTS_awe-greedy-th0.35-grip/COFFEE_PREPERATION_D1"
...
DEST_EXTRA_DIR="${SCRATCH_ROOT}/COFFEE_PREPERATION_D1_extra_goals_awe_${NUM_DEMOS}demo"
...
pixi run python scripts/train.py \
    ...
    "hydra.run.dir=logs/train_COFFEE_PREPERATION_D1_GOAL_SWAP_AWE_GRIP_${NUM_DEMOS}demo/$(date +%Y-%m-%d/%H-%M-%S)" \
