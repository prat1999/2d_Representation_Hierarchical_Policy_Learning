...
#SBATCH --job-name hammer-cleanup-d1-high-level-awe-grip-100demo
#SBATCH -o /ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Code/2d_Representation_Hierarchical_Policy_Learning/ROBO_HIGH_LEVEL_TRAINING_SCRIPT/RDP_TRAINING_SCRIPTS/HAMMER_CLEANUP_D1/AWE_GRIP_FOLDER/logs/job_%j.out
#SBATCH -e /ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Code/2d_Representation_Hierarchical_Policy_Learning/ROBO_HIGH_LEVEL_TRAINING_SCRIPT/RDP_TRAINING_SCRIPTS/HAMMER_CLEANUP_D1/AWE_GRIP_FOLDER/logs/job_%j.err
#SBATCH --mail-type=END
#SBATCH --mail-user=pbhowal@andrew.cmu.edu

# 100-DEMO variant: train articubot (GMM cross-displacement high-level policy)
# on HammerCleanupD1 using AWE-grip goals (goal_gripper_pcd_awe) from the
...
# identical to RDP_FOLDER/hammercleanD1_100.sh so the goal sources are
# directly comparable.
...
EXTRA_SRC_DIR="/ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Dataset/D2/EXTRA_KEYPOINTS/AWE_EXTRA_KEYPOINTS/EXTRA_KEYPOINTS_awe-greedy-th0.35-grip/HAMMER_CLEANUP_D1"
...
DEST_EXTRA_DIR="${SCRATCH_ROOT}/HAMMER_CLEANUP_D1_extra_goals_awe_${NUM_DEMOS}demo"
...
pixi run python scripts/train.py \
    ...
    "hydra.run.dir=logs/train_HammerCleanup_D1_GOAL_SWAP_AWE_GRIP_${NUM_DEMOS}demo/$(date +%Y-%m-%d/%H-%M-%S)" \
