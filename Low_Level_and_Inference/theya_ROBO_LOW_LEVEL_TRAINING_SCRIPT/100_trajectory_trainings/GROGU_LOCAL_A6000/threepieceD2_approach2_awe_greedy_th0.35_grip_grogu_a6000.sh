...
#SBATCH --job-name threepiece-d2-approach2-awe-greedy-th0.35-grip-grogu-a6000
#SBATCH -o /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/threepiece-d2-approach2-awe-greedy-th0.35-grip-grogu-a6000_job_%j.out
#SBATCH -e /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/threepiece-d2-approach2-awe-greedy-th0.35-grip-grogu-a6000_job_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=teswaram@andrew.cmu.edu

# ===========================================================================
# APPROACH 2 (GMM-as-auxiliary-loss) on THREE_PIECE_ASSEMBLY_D2  --  goal_source=awe (greedy, err_th=0.35, WITH gripper)
# grogu cluster / dheld partition, pinned to grogu-4-23 (8x RTX 6000 Blackwell).
#
# NEW_TASKS port of
# GROGU_BLACKWELL/coffee_preperationD1_approach2_awe_greedy_th0.35_grip_grogu_a6000.sh
...
#   threepieceD2_approach2_auxregression_relgripper_c1_10_grogu_a6000.sh  (regression head, c1=10)
#   threepieceD2_approach2_nogmm_grogu_a6000.sh                           (no auxiliary head at all)
...
#     the pool at data/NEW_TASKS/NO_GMM_preds/three_piece_assembly_d2 is written once and reused.
...
SRC_NPZ_DIR="${SRC_NPZ_DIR:-/home/teswaram/data/NEW_TASKS/three_piece_assembly_d2}"
EXTRA_GOALS_DIR="/home/teswaram/data/NEW_TASKS/EXTRA_KEYPOINTS_awe-greedy-th0.35-grip/three_piece_assembly_d2"
LOCAL_NO_GMM_H5_DIR="${LOCAL_NO_GMM_H5_DIR:-/project_data/held/teswaram/data/NEW_TASKS/NO_GMM_preds/three_piece_assembly_d2}"
...
# flock-guarded and SHARED by all three three_piece_assembly_d2 Approach-2 arms
...
DEST_DATA_DIR="${SCRATCH_ROOT}/ThreePieceAssembly_D2_Approach2_${SOURCE_TAG}"
...
RUN_NAME="ThreePieceAssembly_D2_APPROACH2_${SOURCE_TAG}_c1_${C1}_${staged_count}demo_dinov2_DIT_grogu_a6000"
...
pixi run python diffusion_policy/train.py \
    ...
    task=MimicGen_Tasks/three_piece_assembly_d2_goal_gmm_aux \
