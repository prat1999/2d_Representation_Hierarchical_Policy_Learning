...
#SBATCH --job-name mugcleanup-d1-approach2-auxregression-relgripper-c1-10-grogu-a6000
#SBATCH -o /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/mugcleanup-d1-approach2-auxregression-relgripper-c1-10-grogu-a6000_job_%j.out
#SBATCH -e /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/mugcleanup-d1-approach2-auxregression-relgripper-c1-10-grogu-a6000_job_%j.err
...
# (mugcleanupD1_approach2_awe_greedy_th0.35_grip_grogu_a6000.sh): same NO_GMM
...
RUN_NAME="Mug_Cleanup_D1_APPROACH2_${SOURCE_TAG}_${AUX_TAG}_c1_${C1}_${staged_count}demo_dinov2_DIT_grogu_a6000"
