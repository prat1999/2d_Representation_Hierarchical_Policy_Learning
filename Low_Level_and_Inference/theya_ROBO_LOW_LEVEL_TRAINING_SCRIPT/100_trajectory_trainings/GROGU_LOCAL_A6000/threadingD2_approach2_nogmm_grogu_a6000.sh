...
#SBATCH --job-name threading-d2-approach2-nogmm-grogu-a6000
#SBATCH -o /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/threading-d2-approach2-nogmm-grogu-a6000_job_%j.out
#SBATCH -e /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/threading-d2-approach2-nogmm-grogu-a6000_job_%j.err
...
# (threadingD2_approach2_awe_greedy_th0.35_grip_grogu_a6000.sh, GMM c1=0.1,
# and threadingD2_approach2_auxregression_relgripper_c1_10_grogu_a6000.sh,
...
RUN_NAME="Threading_D2_APPROACH2_${ARM_TAG}_${staged_count}demo_dinov2_DIT_grogu_a6000"
