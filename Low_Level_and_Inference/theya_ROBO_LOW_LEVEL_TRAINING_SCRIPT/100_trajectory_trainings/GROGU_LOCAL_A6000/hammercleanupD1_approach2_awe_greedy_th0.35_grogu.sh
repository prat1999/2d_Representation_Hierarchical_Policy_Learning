...
#SBATCH -t 48:00:00
#SBATCH --job-name hammer-cleanup-d1-approach2-awe-greedy-th0.35-grogu
#SBATCH -o /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/hammer-cleanup-d1-approach2-awe-greedy-th0.35-grogu_job_%j.out
#SBATCH -e /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/hammer-cleanup-d1-approach2-awe-greedy-th0.35-grogu_job_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=teswaram@andrew.cmu.edu

# ===========================================================================
# APPROACH 2 (GMM-as-auxiliary-loss) on HAMMER_CLEANUP_D1  —  goal_source=awe (greedy, err_th=0.35, no-gripper)
# grogu cluster / dheld partition (8x A6000 48GB per node) local rewrite of
# the PSC/Bridges2 H100 script (.../PSC.../HAMMER_CLEANUP_D1_TASK/Approach2/
# hammercleanupD1_approach2_awe_greedy_th0.35_nogrip.sh). See that script's header
...
#   - EXTRA_GOALS_DIR (EXTRA_KEYPOINTS_awe-greedy-th0.35_nogrip/HAMMER_CLEANUP_D1)
...
EXTRA_GOALS_DIR="/project_data/held/teswaram/data/D1/EXTRA_KEYPOINTS/EXTRA_KEYPOINTS_awe-greedy-th0.35_nogrip/HAMMER_CLEANUP_D1"
...
RUN_NAME="Hammer_Cleanup_D1_APPROACH2_${SOURCE_TAG}_c1_${C1}_${staged_count}demo_dinov2_DIT_grogu"
