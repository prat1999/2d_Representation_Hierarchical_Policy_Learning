...
#SBATCH --cpus-per-task=15    # matches dataloader.num_workers=15 below. NOT the usual 16: grogu-1-25
                              # has 128 CPUs and 7 sibling jobs hold 112, so exactly 15 remain once the
                              # 8th GPU is freed -- 16 would leave this arm queued forever on that node.
                              # One fewer dataloader worker is negligible; these runs are GPU-bound.
...
#SBATCH --job-name threepiece-d2-approach2-nogmm-grogu-a6000
#SBATCH -o /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/threepiece-d2-approach2-nogmm-grogu-a6000_job_%j.out
#SBATCH -e /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/threepiece-d2-approach2-nogmm-grogu-a6000_job_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=teswaram@andrew.cmu.edu

# ===========================================================================
# APPROACH 2 *CONTROL ARM* (arm B) on THREE_PIECE_ASSEMBLY_D2
...
# (threepieceD2_approach2_awe_greedy_th0.35_grip_grogu_a6000.sh, GMM c1=0.1,
# and threepieceD2_approach2_auxregression_relgripper_c1_10_grogu_a6000.sh,
...
DEST_DATA_DIR="${SCRATCH_ROOT}/ThreePieceAssembly_D2_Approach2_${ARM_TAG}"
...
RUN_NAME="ThreePieceAssembly_D2_APPROACH2_${ARM_TAG}_${staged_count}demo_dinov2_DIT_grogu_a6000"
