...
#SBATCH --job-name mugcleanup-d1-approach2-awe-greedy-th0.35-grip-grogu-a6000
#SBATCH -o /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/mugcleanup-d1-approach2-awe-greedy-th0.35-grip-grogu-a6000_job_%j.out
#SBATCH -e /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/mugcleanup-d1-approach2-awe-greedy-th0.35-grip-grogu-a6000_job_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=teswaram@andrew.cmu.edu

# ===========================================================================
# APPROACH 2 (GMM-as-auxiliary-loss) on MUG_CLEANUP_D1 (the D2-tree mug task)  --  goal_source=awe (greedy, err_th=0.35, WITH gripper)
...
#   mugcleanupD1_approach2_auxregression_relgripper_c1_10_grogu_a6000.sh  (regression head, c1=10)
#   mugcleanupD1_approach2_nogmm_grogu_a6000.sh                           (no auxiliary head at all)
...
#     the pool at data/D2/NO_GMM_preds/Mug_Cleanup_D1 is written once and reused.
...
EXTRA_GOALS_DIR="/project_data/held/teswaram/data/D2/EXTRA_KEYPOINTS_awe-greedy-th0.35-grip/Mug_Cleanup_D1"
...
DEST_DATA_DIR="${SCRATCH_ROOT}/Mug_Cleanup_D1_Approach2_${SOURCE_TAG}"
...
RUN_NAME="Mug_Cleanup_D1_APPROACH2_${SOURCE_TAG}_c1_${C1}_${staged_count}demo_dinov2_DIT_grogu_a6000"
