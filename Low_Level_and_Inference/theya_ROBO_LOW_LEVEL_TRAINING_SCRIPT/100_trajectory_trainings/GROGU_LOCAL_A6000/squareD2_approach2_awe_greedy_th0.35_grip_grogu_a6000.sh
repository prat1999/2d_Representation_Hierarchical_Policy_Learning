...
#SBATCH --job-name square-d2-approach2-awe-greedy-th0.35-grip-grogu-a6000
#SBATCH -o /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/square-d2-approach2-awe-greedy-th0.35-grip-grogu-a6000_job_%j.out
#SBATCH -e /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/square-d2-approach2-awe-greedy-th0.35-grip-grogu-a6000_job_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=teswaram@andrew.cmu.edu

# ===========================================================================
# APPROACH 2 (GMM-as-auxiliary-loss) on SQUARE_D2  --  goal_source=awe (greedy, err_th=0.35, WITH gripper)
...
#   squareD2_approach2_auxregression_relgripper_c1_10_grogu_a6000.sh  (regression head, c1=10)
#   squareD2_approach2_nogmm_grogu_a6000.sh                           (no auxiliary head at all)
...
#     the pool at data/NEW_TASKS/NO_GMM_preds/square_d2 is written once and reused.
...
DEST_DATA_DIR="${SCRATCH_ROOT}/Square_D2_Approach2_${SOURCE_TAG}"
...
RUN_NAME="Square_D2_APPROACH2_${SOURCE_TAG}_c1_${C1}_${staged_count}demo_dinov2_DIT_grogu_a6000"
