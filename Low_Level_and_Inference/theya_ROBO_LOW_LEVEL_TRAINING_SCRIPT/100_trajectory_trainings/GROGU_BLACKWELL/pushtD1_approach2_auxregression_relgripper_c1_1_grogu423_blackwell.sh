...
#SBATCH -w grogu-4-23
#SBATCH -t 24:00:00
#SBATCH --job-name pusht-d1-approach2-auxregression-relgripper-c1-1-grogu423-blackwell
#SBATCH -o /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/pusht-d1-approach2-auxregression-relgripper-c1-1-grogu423-blackwell_job_%j.out
#SBATCH -e /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/pusht-d1-approach2-auxregression-relgripper-c1-1-grogu423-blackwell_job_%j.err
...
#
# The relative-frame twin of
# pushtD1_approach2_auxregression_absolute_c1_1_grogu423_blackwell.sh --
# identical in every respect except the regression target frame.
#
...
DEST_DATA_DIR="${SCRATCH_ROOT}/PushT_D1_Approach2_${SOURCE_TAG}_auxhead_regression_frame_rel_gripper"
