...
#SBATCH --job-name pickplace-d0-approach2-awe-greedy-th0.35-grip-grogu423-blackwell
#SBATCH -o /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/pickplace-d0-approach2-awe-greedy-th0.35-grip-grogu423-blackwell_job_%j.out
#SBATCH -e /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/pickplace-d0-approach2-awe-greedy-th0.35-grip-grogu423-blackwell_job_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=teswaram@andrew.cmu.edu

# ===========================================================================
# APPROACH 2 (GMM-as-auxiliary-loss) on PICK_PLACE_D0  --  goal_source=awe (greedy, err_th=0.35, WITH gripper)
...
#   pickplaceD0_approach2_auxregression_relgripper_c1_10_grogu423_blackwell.sh  (regression head, c1=10)
#   pickplaceD0_approach2_nogmm_grogu423_blackwell.sh                           (no auxiliary head at all)
...
#     the pool at data/NEW_TASKS/NO_GMM_preds/pick_place_d0 is written once and reused.
...
#
# KEYPOINT COVERAGE: the pick_place_d0 tree in EXTRA_KEYPOINTS_awe-greedy-th0.35-grip
# was still being generated earlier on 2026-09-10 (32 -> 42 -> 93 demos); it reached
# full 100/100 coverage before this arm was submitted, so staging intersects to the
# same demo_0..demo_99 set the no-aux control arm uses and the arms are comparable.
# Still worth confirming "[stage] ... common: 100" in the log.
# ===========================================================================
...
EXTRA_GOALS_DIR="/home/teswaram/data/NEW_TASKS/EXTRA_KEYPOINTS_awe-greedy-th0.35-grip/pick_place_d0"
...
DEST_DATA_DIR="${SCRATCH_ROOT}/PickPlace_D0_Approach2_${SOURCE_TAG}"
...
RUN_NAME="PickPlace_D0_APPROACH2_${SOURCE_TAG}_c1_${C1}_${staged_count}demo_dinov2_DIT_grogu423_blackwell"
