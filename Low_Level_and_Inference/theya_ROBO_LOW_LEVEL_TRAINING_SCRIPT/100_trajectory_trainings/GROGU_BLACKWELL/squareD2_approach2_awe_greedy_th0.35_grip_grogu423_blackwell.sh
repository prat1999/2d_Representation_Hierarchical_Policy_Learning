...
#SBATCH --job-name square-d2-approach2-awe-greedy-th0.35-grip-grogu423-blackwell
#SBATCH -o /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/square-d2-approach2-awe-greedy-th0.35-grip-grogu423-blackwell_job_%j.out
#SBATCH -e /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/square-d2-approach2-awe-greedy-th0.35-grip-grogu423-blackwell_job_%j.err
...
#   squareD2_approach2_auxregression_relgripper_c1_10_grogu423_blackwell.sh  (regression head, c1=10)
#   squareD2_approach2_nogmm_grogu423_blackwell.sh                           (no auxiliary head at all)
...
RUN_NAME="Square_D2_APPROACH2_${SOURCE_TAG}_c1_${C1}_${staged_count}demo_dinov2_DIT_grogu423_blackwell"
