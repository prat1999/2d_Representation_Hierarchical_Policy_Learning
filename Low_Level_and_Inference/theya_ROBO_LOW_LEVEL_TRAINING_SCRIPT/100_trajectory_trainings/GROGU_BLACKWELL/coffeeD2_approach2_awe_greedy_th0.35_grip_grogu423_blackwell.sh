...
#SBATCH --job-name coffee-d2-approach2-awe-greedy-th0.35-grip-grogu423-blackwell
#SBATCH -o /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/coffee-d2-approach2-awe-greedy-th0.35-grip-grogu423-blackwell_job_%j.out
#SBATCH -e /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/coffee-d2-approach2-awe-greedy-th0.35-grip-grogu423-blackwell_job_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=teswaram@andrew.cmu.edu

# ===========================================================================
# APPROACH 2 (GMM-as-auxiliary-loss) on COFFEE_D2  --  goal_source=awe (greedy, err_th=0.35, WITH gripper)
# grogu cluster / dheld partition, pinned to grogu-4-23 (8x RTX 6000 Blackwell).
#
# D2-generation port of
...
#   coffeeD2_approach2_auxregression_relgripper_c1_10_grogu423_blackwell.sh  (regression head, c1=10)
#   coffeeD2_approach2_nogmm_grogu423_blackwell.sh                           (no auxiliary head at all)
...
#     the pool at data/D2/NO_GMM_preds/Coffee_D2 is written once and reused.
...
# --- paths -----------------------------------------------------------------
# Coffee_D2 lives under data/D2 (npz demo_N/ dirs, same GROOT-style format as
# the D1 trees: 256x256 rgb+depth, per-camera intrinsics/extrinsics, state[10]).
SRC_NPZ_DIR="${SRC_NPZ_DIR:-/project_data/held/teswaram/data/D2/Coffee_D2}"
EXTRA_GOALS_DIR="/project_data/held/teswaram/data/D2/EXTRA_KEYPOINTS_awe-greedy-th0.35-grip/Coffee_D2"
LOCAL_NO_GMM_H5_DIR="/project_data/held/teswaram/data/D2/NO_GMM_preds/Coffee_D2"
...
# flock-guarded and SHARED by all three Coffee_D2 Approach-2 arms
...
DEST_DATA_DIR="${SCRATCH_ROOT}/Coffee_D2_Approach2_${SOURCE_TAG}"
...
RUN_NAME="Coffee_D2_APPROACH2_${SOURCE_TAG}_c1_${C1}_${staged_count}demo_dinov2_DIT_grogu423_blackwell"
...
pixi run python diffusion_policy/train.py \
    ...
    task=MimicGen_Tasks/coffee_D2_goal_gmm_aux \
