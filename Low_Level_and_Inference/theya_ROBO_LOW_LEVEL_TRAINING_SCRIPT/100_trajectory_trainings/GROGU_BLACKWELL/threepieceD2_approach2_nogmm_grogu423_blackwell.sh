...
#SBATCH --job-name threepiece-d2-approach2-nogmm-grogu423-blackwell
#SBATCH -o /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/threepiece-d2-approach2-nogmm-grogu423-blackwell_job_%j.out
#SBATCH -e /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/threepiece-d2-approach2-nogmm-grogu423-blackwell_job_%j.err
...
# (threepieceD2_approach2_awe_greedy_th0.35_grip_grogu423_blackwell.sh, GMM c1=0.1,
# and threepieceD2_approach2_auxregression_relgripper_c1_10_grogu423_blackwell.sh,
...
RUN_NAME="ThreePieceAssembly_D2_APPROACH2_${ARM_TAG}_${staged_count}demo_dinov2_DIT_grogu423_blackwell"
