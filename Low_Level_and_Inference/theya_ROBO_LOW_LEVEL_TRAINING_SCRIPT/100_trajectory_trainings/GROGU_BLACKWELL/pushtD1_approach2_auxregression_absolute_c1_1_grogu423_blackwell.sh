...
#SBATCH -w grogu-4-23
#SBATCH -t 24:00:00
#SBATCH --job-name pusht-d1-approach2-auxregression-absolute-c1-1-grogu423-blackwell
#SBATCH -o /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/pusht-d1-approach2-auxregression-absolute-c1-1-grogu423-blackwell_job_%j.out
#SBATCH -e /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/pusht-d1-approach2-auxregression-absolute-c1-1-grogu423-blackwell_job_%j.err
...
#
# The absolute-frame, c1=1 arm of the PushT_D1 regression sweep. Data pool,
# EXTRA_KEYPOINTS tree, staging, injection, node pinning, batch size and
# checkpointing are inherited unchanged from
# PUSHT_D1_TASK/Approach2/pushtD1_approach2_awe_greedy_th0.35.sh; the only
# changes are the auxiliary head and its target frame.
#
...
#
#   C1=1.0 is this file's default; NUM_DEMOS/NUM_EPOCHS/RESUME_CKPT overridable
# ===========================================================================
set -euo pipefail
set -x
