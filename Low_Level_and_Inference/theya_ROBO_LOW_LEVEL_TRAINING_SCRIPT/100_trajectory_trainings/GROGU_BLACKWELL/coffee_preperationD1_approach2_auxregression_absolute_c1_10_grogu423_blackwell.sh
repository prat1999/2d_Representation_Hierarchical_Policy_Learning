...
#SBATCH -t 24:00:00
#SBATCH --job-name coffee-prep-d1-approach2-auxregression-absolute-c1-10-grogu423-blackwell
#SBATCH -o /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/coffee-prep-d1-approach2-auxregression-absolute-c1-10-grogu423-blackwell_job_%j.out
#SBATCH -e /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/coffee-prep-d1-approach2-auxregression-absolute-c1-10-grogu423-blackwell_job_%j.err
...
# coffee_preperationD1_approach2_auxregression_relgripper_c1_1_grogu423_blackwell.sh
...
#
# (COFFEE_PREPERATION_D1: 0.31, 0.051, 0.014 m^2.)
#
...
#   * absolute reaches 0.008, BELOW its own const-pred floor (0.051), i.e.
...
# drop from ~0.26 onto ~0.051 inside the first ~10 steps, then a slow decay
# THROUGH that floor. If it plateaus AT ~0.051 and stops, the head has
