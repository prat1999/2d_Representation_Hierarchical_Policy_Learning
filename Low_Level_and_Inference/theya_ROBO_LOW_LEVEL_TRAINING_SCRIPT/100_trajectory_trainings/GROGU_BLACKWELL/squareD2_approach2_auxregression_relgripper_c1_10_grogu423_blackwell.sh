...
#SBATCH --job-name square-d2-approach2-auxregression-relgripper-c1-10-grogu423-blackwell
#SBATCH -o /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/square-d2-approach2-auxregression-relgripper-c1-10-grogu423-blackwell_job_%j.out
#SBATCH -e /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/square-d2-approach2-auxregression-relgripper-c1-10-grogu423-blackwell_job_%j.err
...
# (squareD2_approach2_awe_greedy_th0.35_grip_grogu423_blackwell.sh): same NO_GMM
...
RUN_NAME="Square_D2_APPROACH2_${SOURCE_TAG}_${AUX_TAG}_c1_${C1}_${staged_count}demo_dinov2_DIT_grogu423_blackwell"
