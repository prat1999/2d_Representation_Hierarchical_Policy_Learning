...
#SBATCH -t 24:00:00
#SBATCH --job-name hammer-cleanup-d1-approach2-auxregression-absolute-c1-10-grogu423-blackwell
#SBATCH -o /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/hammer-cleanup-d1-approach2-auxregression-absolute-c1-10-grogu423-blackwell_job_%j.out
#SBATCH -e /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/hammer-cleanup-d1-approach2-auxregression-absolute-c1-10-grogu423-blackwell_job_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=teswaram@andrew.cmu.edu

# ===========================================================================
# APPROACH 2, REGRESSION auxiliary head on HAMMER_CLEANUP_D1
...
# hammercleanupD1_approach2_auxregression_relgripper_c1_1_grogu423_blackwell.sh
...
#
# (HAMMER_CLEANUP_D1: 0.27, 0.022, 0.017 m^2.)
#
...
#   * absolute reaches 0.008, BELOW its own const-pred floor (0.022), i.e.
...
# drop from ~0.26 onto ~0.022 inside the first ~10 steps, then a slow decay
# THROUGH that floor. If it plateaus AT ~0.022 and stops, the head has
...
DEST_DATA_DIR="${SCRATCH_ROOT}/Hammer_Cleanup_D1_Approach2_${SOURCE_TAG}_${AUX_TAG}"
...
RUN_NAME="Hammer_Cleanup_D1_APPROACH2_${SOURCE_TAG}_${AUX_TAG}_c1_${C1}_${staged_count}demo_dinov2_DIT_grogu423_blackwell"
