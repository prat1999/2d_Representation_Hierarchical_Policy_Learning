...
#SBATCH --job-name coffee-d2-approach2-auxregression-relgripper-c1-10-grogu423-blackwell
#SBATCH -o /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/coffee-d2-approach2-auxregression-relgripper-c1-10-grogu423-blackwell_job_%j.out
#SBATCH -e /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/coffee-d2-approach2-auxregression-relgripper-c1-10-grogu423-blackwell_job_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=teswaram@andrew.cmu.edu

# ===========================================================================
# APPROACH 2, REGRESSION auxiliary head on COFFEE_D2
...
# GROGU_BLACKWELL/coffee_preperationD1_approach2_auxregression_relgripper_c1_10_grogu423_blackwell.sh
...
# (coffeeD2_approach2_awe_greedy_th0.35_grip_grogu423_blackwell.sh): same NO_GMM
...
DEST_DATA_DIR="${SCRATCH_ROOT}/Coffee_D2_Approach2_${SOURCE_TAG}_${AUX_TAG}"
...
RUN_NAME="Coffee_D2_APPROACH2_${SOURCE_TAG}_${AUX_TAG}_c1_${C1}_${staged_count}demo_dinov2_DIT_grogu423_blackwell"
