...
#SBATCH -t 24:00:00
#SBATCH --job-name kitchen-d1-approach2-auxregression-absolute-c1-1-grogu423-blackwell
#SBATCH -o /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/kitchen-d1-approach2-auxregression-absolute-c1-1-grogu423-blackwell_job_%j.out
#SBATCH -e /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/kitchen-d1-approach2-auxregression-absolute-c1-1-grogu423-blackwell_job_%j.err
