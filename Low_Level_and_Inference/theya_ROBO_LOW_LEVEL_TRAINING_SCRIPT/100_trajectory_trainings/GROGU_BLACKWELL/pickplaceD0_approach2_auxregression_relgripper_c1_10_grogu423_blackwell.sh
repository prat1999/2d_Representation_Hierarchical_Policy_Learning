...
#SBATCH --job-name pickplace-d0-approach2-auxregression-relgripper-c1-10-grogu423-blackwell
#SBATCH -o /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/pickplace-d0-approach2-auxregression-relgripper-c1-10-grogu423-blackwell_job_%j.out
#SBATCH -e /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/pickplace-d0-approach2-auxregression-relgripper-c1-10-grogu423-blackwell_job_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=teswaram@andrew.cmu.edu

# ===========================================================================
# APPROACH 2, REGRESSION auxiliary head on PICK_PLACE_D0
...
# (pickplaceD0_approach2_awe_greedy_th0.35_grip_grogu423_blackwell.sh): same NO_GMM
...
DEST_DATA_DIR="${SCRATCH_ROOT}/PickPlace_D0_Approach2_${SOURCE_TAG}_${AUX_TAG}"
...
RUN_NAME="PickPlace_D0_APPROACH2_${SOURCE_TAG}_${AUX_TAG}_c1_${C1}_${staged_count}demo_dinov2_DIT_grogu423_blackwell"
