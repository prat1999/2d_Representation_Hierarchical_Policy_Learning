...
#SBATCH --mem=120G            # 80G->160G after hammer-cleanup sibling oom-killed, ->120G + pin_memory=false to test the leak hypothesis
#SBATCH -p dheld
#SBATCH --gres=gpu:1
#SBATCH -w grogu-4-23         # pin to the RTX 6000 Blackwell node
#SBATCH -C 6000Blackwell      # pin to the RTX 6000 Blackwell node
#SBATCH -t 48:00:00
#SBATCH --job-name coffee-prep-d1-approach2-awe-greedy-th0.35-grip-10hz
#SBATCH -o /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/coffee-prep-d1-approach2-awe-greedy-th0.35-grip-10hz_job_%j.out
#SBATCH -e /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/coffee-prep-d1-approach2-awe-greedy-th0.35-grip-10hz_job_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=teswaram@andrew.cmu.edu

# ===========================================================================
# RATE ABLATION on COFFEE_PREPERATION_D1  --  APPROACH 2 (GMM-as-auxiliary-loss),
# goal_source=awe (greedy, err_th=0.35, WITH gripper), control rate=10Hz.
#
# Sibling of the other RATE_ABLATIONS/COFFEE_PREPERATION_D1/*.sh scripts -- same
...
# ../../GROGU_LOCAL_A6000/coffee_preperationD1_approach2_awe_greedy_th0.35_grip_grogu.sh,
# and a direct analogue of ../HAMMER_CLEANUP_D1/coffee_preperationD1_approach2_awe_greedy_th0.35_grip_10hz.sh
# for the coffee-preparation task.
#
# The demo_N/ npz -> h5 conversion step is skipped entirely:
# /project_data/held/teswaram/data/rate_ablations/h5/coffee_preparation_d1_10hz/
...
# --- paths -------------------------------------------------------------------
RATE_H5_DIR="/project_data/held/teswaram/data/rate_ablations/h5/coffee_preparation_d1_10hz"
EXTRA_GOALS_DIR="/project_data/held/teswaram/data/rate_ablations/npz/EXTRA_KEYPOINTS_awe-greedy-th0.35-grip/coffee_preparation_d1_10hz"
...
echo "[src] ${rate_h5_count} h5 files present in ${RATE_H5_DIR} (10hz pool)"
...
DEST_DATA_DIR="${SCRATCH_ROOT}/Coffee_Preparation_D1_Approach2_${SOURCE_TAG}_10hz"
...
RUN_NAME="Coffee_Preparation_D1_APPROACH2_${SOURCE_TAG}_c1_${C1}_${staged_count}demo_10hz_dinov2_DIT_grogu"
