...
#SBATCH -t 48:00:00
#SBATCH --job-name coffee-prep-d1-approach2-awe-greedy-th0.35-grip-20hz
#SBATCH -o /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/coffee-prep-d1-approach2-awe-greedy-th0.35-grip-20hz_job_%j.out
#SBATCH -e /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/coffee-prep-d1-approach2-awe-greedy-th0.35-grip-20hz_job_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=teswaram@andrew.cmu.edu

# ===========================================================================
# RATE ABLATION on COFFEE_PREPERATION_D1  --  APPROACH 2 (GMM-as-auxiliary-loss),
# goal_source=awe (greedy, err_th=0.35, WITH gripper), control rate=20Hz.
#
...
# and a direct analogue of ../HAMMER_CLEANUP_D1/coffee_preperationD1_approach2_awe_greedy_th0.35_grip_20hz.sh
# for the coffee-preparation task.
#
# The demo_N/ npz -> h5 conversion step is skipped entirely:
# /project_data/held/teswaram/data/rate_ablations/h5/coffee_preparation_d1_20hz/
...
# --- paths -------------------------------------------------------------------
RATE_H5_DIR="/project_data/held/teswaram/data/rate_ablations/h5/coffee_preparation_d1_20hz"
EXTRA_GOALS_DIR="/project_data/held/teswaram/data/rate_ablations/npz/EXTRA_KEYPOINTS_awe-greedy-th0.35-grip/coffee_preparation_d1_20hz"
...
echo "[src] ${rate_h5_count} h5 files present in ${RATE_H5_DIR} (20hz pool)"
...
DEST_DATA_DIR="${SCRATCH_ROOT}/Coffee_Preparation_D1_Approach2_${SOURCE_TAG}_20hz"
...
RUN_NAME="Coffee_Preparation_D1_APPROACH2_${SOURCE_TAG}_c1_${C1}_${staged_count}demo_20hz_dinov2_DIT_grogu"
