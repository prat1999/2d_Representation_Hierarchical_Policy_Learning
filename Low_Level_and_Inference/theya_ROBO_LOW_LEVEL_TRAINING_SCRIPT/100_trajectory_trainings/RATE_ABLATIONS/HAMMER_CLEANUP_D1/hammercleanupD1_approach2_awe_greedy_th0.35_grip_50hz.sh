...
#SBATCH -t 48:00:00
#SBATCH --job-name hammer-cleanup-d1-approach2-awe-greedy-th0.35-grip-50hz
#SBATCH -o /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/hammer-cleanup-d1-approach2-awe-greedy-th0.35-grip-50hz_job_%j.out
#SBATCH -e /home/teswaram/code/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/hammer-cleanup-d1-approach2-awe-greedy-th0.35-grip-50hz_job_%j.err
...
# entirely: /project_data/held/teswaram/data/rate_ablations/h5/hammer_cleanup_d1_50hz/
...
# --- paths -------------------------------------------------------------------
RATE_H5_DIR="/project_data/held/teswaram/data/rate_ablations/h5/hammer_cleanup_d1_50hz"
EXTRA_GOALS_DIR="/project_data/held/teswaram/data/rate_ablations/npz/EXTRA_KEYPOINTS_awe-greedy-th0.35-grip/hammer_cleanup_d1_50hz"
